  ...
  return (
    <div className="flex flex-col items-center gap-1.5">
      ...
      <button
        ...
        disabled={isPending}
        className="relative w-20 h-20 rounded-xl overflow-hidden border-2 border-dashed border-gray-200 bg-gray-50 hover:border-[#E4570F] hover:bg-orange-50 transition-colors focus:outline-none focus:ring-2 focus:ring-[#E4570F]/30 flex items-center justify-center group"
