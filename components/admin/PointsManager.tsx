  ...
  return (
    <form ref={formRef} onSubmit={handleSubmit} className="space-y-3">
      <div className="flex items-center gap-2 text-xs text-gray-500 mb-2">
        ...
        <span className="font-bold text-[#1E2A4A]">{currentBalance} نقطة</span>
      </div>
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 min-w-0 rounded-lg border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1E2A4A]"
        />
        <select
          name="type"
          required
          ...
          className="rounded-lg border border-gray-200 px-2 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1E2A4A]"
        >
      ...
      <button
        type="submit"
        disabled={isPending}
        className="w-full min-h-[44px] rounded-lg bg-[#1E2A4A] text-white text-sm font-medium disabled:opacity-50 transition-opacity"
      >
