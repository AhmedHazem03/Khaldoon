...
interface WhatsappButtonProps {
  order: Parameters<typeof generateWhatsAppMessage>[0];
  items: Parameters<typeof generateWhatsAppMessage>[1];
  settings: Pick<Settings, "whatsapp_order_number" | "point_value_egp">;
  orderId: string;
...
export default function WhatsappButton({
  ...
  async function handleClick() {
    ...
    const message = generateWhatsAppMessage(order, items, settings);
